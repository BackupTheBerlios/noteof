...
public enum ConfigSection {
    ...
    /**
     * Template und Configuration dienen der Unterscheidung, ob ein Wert aus der Konfiguration oder aus der Vorlage gelesen werden soll.
     */
    TEMPLATE("notIOC_template"),
    /**
     * Template und Configuration dienen der Unterscheidung, ob ein Wert aus der Konfiguration oder aus der Vorlage gelesen werden soll.
     */
    // CONFIGURATION("notIOC_configuration"),
    /**
     ...
     * <p>
     * Achtung - Eintraege dieser Liste korrespondieren mit Liste aus XMLFileSections.
     */
     ...
     * Zugriff auf Liste der Sectionsnamen.
     * <p>
     * Achtung - Eintraege dieser Liste korrespondieren mit Liste aus XMLFileNames.
     */
    // XML_FILE_SECTIONS("section.[@sectionName]"),
    /**
     * Alle konfigurierten Parameter
     */
    NOTIOC_SECTIONS("notIOCSections"), INDEX("index"), DESCRIPTION("description"),
