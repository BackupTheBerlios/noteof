...
public class CompositeConfigurationNotIOC extends org.apache.commons.configuration.CompositeConfiguration {

    public void setProperty(String key, String value) throws NotIOCException {
        setProperty(key, value, null);
    }

    public void setProperty(String key, String value, String xmlFileName) throws NotIOCException {
        ...
        if (null != anyConfig) {
            ...
            try {
                ...
                throw new NotIOCException(10L, "Update des Wertes", ex);
            }
            ...
            try {
                ...
                throw new NotIOCException(10L, "Neu Setzen (kein Hinzufügen)", ex);
            }
        } else {
            try {
                ...
                throw new NotIOCException(10L, "Neues Element hinzufügen", ex);
            }
        }
    }

    /**
     * Problem war das Schreiben neuer Werte ohne zusaetzliche Angabe der jeweiligen Konfiguration(-sdatei).
     * 
     * @param key
     ...
     */
    public void addProperty(String key, String value, String xmlFileName) throws NotIOCException {
        if (Util.isEmpty(xmlFileName)) {
            throw new NotIOCException(11L, "Fehlende Angabe: xmlFileName");
        }
        ...
        try {
            ...
            throw new NotIOCException(11L, "Konfigurations-Datei ist " + xmlFileName, ex);
        }
    }

    private Configuration searchConfigurationParent(String key) throws NotIOCException {
     ...
     * 1. Suche ueber commons.configuration (da die Konfiguration bereits im Speicher ist) <br>
     * 2. Bei Nichterfolg Suche ueber SAX und XPath-Ausdruecke.
     * <p>
     * Die Suche bezieht sich auf alle in iccs_master_conf.xml hinterlegten XML-Dateien.
     * 
     * @param nodeName
     *            Ist der 'Schluessel'. Zulaessig sind Ausdruecke wie z.B. /hibernate
     ...
     * <p>
     * Die vom Iterator zur Verfuegung gestellten Objekte muessen in der Anwendung auf (org.dom4j.Node) gecastet werden. <br>
     * Die Suche bezieht sich auf alle in iccs_master_conf.xml hinterlegten XML-Dateien.
     * 
     * @param nodeName
     ...
     * @return null oder eine passende Konfiguration. Existiert derselbe Schluessel in zwei Konfigurationsdateien, wird die zuerst gefundene
     *         Configuration zurueckgeliefert.
     */
    public Configuration retrieveConfiguration(String elementName) throws NotIOCException {
        Configuration anyConfig = null;
        int i = 0;
        try {
            ...
            throw new NotIOCException(12L, ": " + elementName, ex);
        }
        return null;
    }
     ...
     * 
     * @param confSection
     *            Ein Enum, dessen Name dem Parameter entspricht, nach dem gesucht wird.
     * @return null oder eine passende Konfiguration. Existiert derselbe Schluessel in zwei Konfigurationen, wird die zuerst gefundene
     *         Configuration zurueckgeliefert.
     */
    public Configuration retrieveConfiguration(ConfigSection confSection) throws NotIOCException {
