    ...
    public void setProperty(String key, String value, String xmlFileName) throws ActionFailedException  {
        ...
        if (null != anyConfig) {
            ...
            try {
                ...
                throw new ActionFailedException(30L, "Neu Setzen (kein Hinzuf�gen)", ex);
            }
        } else {
            ...
            if (null == value) {
                ...
                while ((null == value || "".equals(value)) && i < maxCounter) {
                    try {
                        ...
                        // Abbrechen der Suche
                        // System.out.println(
                        // "Die Konfiguration der iccs_master_conf.xml wurde wahrscheinlich nicht vollst�ndig durchgef�hrt.\n"
                        // +
